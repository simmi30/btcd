...
func addNaTests() {
	// IPv4
	// Localhost
	addNaTest("127.0.0.1", 8722, "127.0.0.1:8722")
	addNaTest("127.0.0.1", 8863, "127.0.0.1:8863")

	// Class A
	addNaTest("1.0.0.1", 8722, "1.0.0.1:8722")
	addNaTest("2.2.2.2", 8863, "2.2.2.2:8863")
	addNaTest("27.253.252.251", 8335, "27.253.252.251:8335")
	addNaTest("123.3.2.1", 8336, "123.3.2.1:8336")

	// Private Class A
	addNaTest("10.0.0.1", 8722, "10.0.0.1:8722")
	addNaTest("10.1.1.1", 8863, "10.1.1.1:8863")
	addNaTest("10.2.2.2", 8335, "10.2.2.2:8335")
	addNaTest("10.10.10.10", 8336, "10.10.10.10:8336")

	// Class B
	addNaTest("128.0.0.1", 8722, "128.0.0.1:8722")
	addNaTest("129.1.1.1", 8863, "129.1.1.1:8863")
	addNaTest("180.2.2.2", 8335, "180.2.2.2:8335")
	addNaTest("191.10.10.10", 8336, "191.10.10.10:8336")

	// Private Class B
	addNaTest("172.16.0.1", 8722, "172.16.0.1:8722")
	addNaTest("172.16.1.1", 8863, "172.16.1.1:8863")
	addNaTest("172.16.2.2", 8335, "172.16.2.2:8335")
	addNaTest("172.16.172.172", 8336, "172.16.172.172:8336")

	// Class C
	addNaTest("193.0.0.1", 8722, "193.0.0.1:8722")
	addNaTest("200.1.1.1", 8863, "200.1.1.1:8863")
	addNaTest("205.2.2.2", 8335, "205.2.2.2:8335")
	addNaTest("223.10.10.10", 8336, "223.10.10.10:8336")

	// Private Class C
	addNaTest("192.168.0.1", 8722, "192.168.0.1:8722")
	addNaTest("192.168.1.1", 8863, "192.168.1.1:8863")
	addNaTest("192.168.2.2", 8335, "192.168.2.2:8335")
	addNaTest("192.168.192.192", 8336, "192.168.192.192:8336")

	// IPv6
	// Localhost
	addNaTest("::1", 8722, "[::1]:8722")
	addNaTest("fe80::1", 8863, "[fe80::1]:8863")

	// Link-local
	addNaTest("fe80::1:1", 8722, "[fe80::1:1]:8722")
	addNaTest("fe91::2:2", 8863, "[fe91::2:2]:8863")
	addNaTest("fea2::3:3", 8335, "[fea2::3:3]:8335")
	addNaTest("feb3::4:4", 8336, "[feb3::4:4]:8336")

	// Site-local
	addNaTest("fec0::1:1", 8722, "[fec0::1:1]:8722")
	addNaTest("fed1::2:2", 8863, "[fed1::2:2]:8863")
...
func TestAttempt(t *testing.T) {
	...
	err := n.AddAddressByIP(someIP + ":8722")
	if err != nil {
...
func TestNeedMoreAddresses(t *testing.T) {
	...
	for i := 0; i < addrsToAdd; i++ {
		s := fmt.Sprintf("%d.%d.173.147:8722", i/128+60, i%128+60)
	...
	srcAddr := wire.NewNetAddressIPPort(net.IPv4(173, 144, 173, 111), 8722, 0)
...
func TestGood(t *testing.T) {
	...
	var err error
	for i := 0; i < addrsToAdd; i++ {
		s := fmt.Sprintf("%d.173.147.%d:8722", i/64+60, i%64+60)
		addrs[i], err = n.DeserializeNetAddress(s, wire.SFNodeNetwork)
		if err != nil {
			t.Errorf("Failed to turn %s into an address: %v", s, err)
		}
