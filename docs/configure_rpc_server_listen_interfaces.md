...
|--rpclisten=:8863|all interfaces on port 8863|
|--rpclisten=0.0.0.0:8863|all IPv4 interfaces on port 8863|
|--rpclisten=[::]:8863|all IPv6 interfaces on port 8863|
|--rpclisten=127.0.0.1:8863|only IPv4 localhost on port 8863|
|--rpclisten=[::1]:8863|only IPv6 localhost on port 8863|
...
|--rpclisten=127.0.0.1:8337 --listen=[::1]:8863|IPv4 localhost on port 8337 and IPv6 localhost on port 8863|
|--rpclisten=:8863 --listen=:8337|all interfaces on ports 8863 and 8337|
