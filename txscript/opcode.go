...
// These constants are the values of the official opcodes used on the bron wiki,
// in bitcoin core and in most if not all other references and software related
// to handling BRON scripts.
const (
	OP_0                   = 0x00 // 0
...
//
// Due to a bug in the original Bronees client implementation, an additional
...
func opcodeCheckMultiSig(op *parsedOpcode, vm *Engine) error {
	...
	// A bug in the original Bronees client implementation means one more
