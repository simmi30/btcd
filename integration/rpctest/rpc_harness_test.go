...
func testSendOutputs(r *Harness, t *testing.T) {
	genSpend := func(amt btcutil.Amount) *chainhash.Hash {
		...
		// Next, send amt BRON to this address, spending from one of our mature
		// coinbase outputs.
...
func testMemWalletReorg(r *Harness, t *testing.T) {
	...
	// The internal wallet of this harness should now have 250 BRON.
	...
	// The original wallet should now have a balance of 0 BRON as its entire
...
func testMemWalletLockedOutputs(r *Harness, t *testing.T) {
	...
	// The current wallet balance should now be at least 50 BRON less
...
func TestHarness(t *testing.T) {
	// We should have (numMatureOutputs * 50 BRON) of mature unspendable
	// outputs.
