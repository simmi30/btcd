...
var helpDescsEnUS = map[string]string{
	...
	"createrawtransaction-amounts--desc":  "The destination address as the key and the amount in BRON as the value",
	...
	"getblocktemplateresulttx-fee":     "Difference in value between transaction inputs and outputs (in Bronees)",
	...
	"getblocktemplateresult-coinbasevalue":              "Total amount available for the coinbase in Bronees",
	...
	"infochainresult-relayfee":        "The minimum relay fee for non-free transactions in BRON/KB",
	...
	"infowalletresult-paytxfee":        "The transaction fee set in BRON/KB",
	...
	"gettxoutresult-value":         "The transaction amount in BRON",
